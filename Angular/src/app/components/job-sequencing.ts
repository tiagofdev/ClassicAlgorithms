...
export class JobSequencing {
  ...
  data = {
    ...
    description: "You are given a list of jobs with their respective deadlines and an associated profit. " +
      "Once the first jobs starts, the deadlines countdown starts for all jobs. \n" +
      "Each job can be executed one at a time. Each job takes exactly one unit of time to be completed. " +
      "Find a sequence of jobs that can be executed so that the total profit is maximized. " +
      "Not all jobs might get included. " +
      "Any job that is chosen needs to finish before their deadline. \n",
    examples: "\n  Input:\n" +
